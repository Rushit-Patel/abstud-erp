        ...
        <div class="kt-container-fixed">
                    ...
                    <div class="kt-card-body p-5">
                        <div class="flex items-center gap-2.5">
                            ...
                            <div class="flex flex-col gap-1">
                                <span class="text-lg font-medium text-mono">{{ $states->total() }}</span>
                                <span class="text-sm text-secondary-foreground">Total States</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="kt-card">
                    <div class="kt-card-body p-5">
                        <div class="flex items-center gap-2.5">
                            ...
                            <div class="flex flex-col gap-1">
                                <span class="text-lg font-medium text-mono">{{ $states->where('is_active', true)->count() }}</span>
                                <span class="text-sm text-secondary-foreground">Active States</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="kt-card">
                <div class="kt-card-header">
                    <h3 class="kt-card-title">States List</h3>
                </div>
                            ...
                            <table class="kt-table kt-table-divider">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="min-w-[100px]">State Code</th>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="flex flex-col">
                                                    <a href="{{ route('team.settings.states.show', $state) }}" 
                                            ...
                                            <td>
                                                <div class="flex items-center gap-2">
                                                    @if($state->country->icon)
                                                        <span>{{ $state->country->icon }}</span>
                                                    @endif
                                                    <span class="text-sm">{{ $state->country->name }}</span>
                                                </div>
                                            </td>
                                            <td>
                                                <span class="text-sm">{{ $state->state_code ?? 'N/A' }}</span>
                                            </td>
                                            <td>
                                                @if($state->is_active)
                                                ...
                                                <div class="kt-dropdown" data-kt-dropdown="true" data-kt-dropdown-attach="parent" data-kt-dropdown-trigger="click">
                                                    ...
                                                    <div class="kt-dropdown-content min-w-[175px]">
                                                        <div class="kt-dropdown-item">
                                                            <a href="{{ route('team.settings.states.show', $state) }}" class="kt-dropdown-link">
                                                                <i class="ki-filled ki-eye me-2"></i>
                                                                View Details
                                                            </a>
                                                        </div>
                                                        <div class="kt-dropdown-item">
                                                            <a href="{{ route('team.settings.states.edit', $state) }}" class="kt-dropdown-link">
                                                                <i class="ki-filled ki-notepad-edit me-2"></i>
                                                                Edit
                                                            </a>
                                                        </div>
                                                        <div class="kt-dropdown-item">
                                                            <form action="{{ route('team.settings.states.toggle-status', $state) }}" method="POST" class="inline">
                                                                @csrf
                                                                @method('PATCH')
                                                        ...
                                                        <div class="kt-dropdown-item">
                                                            <form action="{{ route('team.settings.states.destroy', $state) }}" method="POST" 
                                                                  onsubmit="return confirm('Are you sure you want to delete this state?')" class="inline">
                                                                @csrf
                                                                @method('DELETE')
                    ...
                    @else
                        <div class="kt-empty-state">
                            ...
                            <div class="kt-empty-state-body">
                                <h3 class="kt-empty-state-title">No States Found</h3>
                                <div class="kt-empty-state-text">
                                    Start by adding your first state or province.
                                </div>
                            </div>
